    ...
    <div class="main-content" id="mainContent">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ul class="breadcrumb">
                ...
                <li class="active">Faculty Substitutions</li>
            </ul>

        </nav>
        <section class="section-header text-sm md:text-xl">
            <h1>Faculty Substitutions</h1>
        </section>
        ...
        function fetchFacultyLoad() {
            $.ajax({
                url: '../FacultyCanTeach1/api/facultyAPI.php',
                type: 'GET',
                data: { action: 'getSubstitutions' },
                    ...
                    if (data.length > 0) {
                        data.forEach(function (item) {
                            table.row.add([
                                ...
                                item.substitute_first_name + ' ' + item.substitute_last_name,
                                item.subject_name,
                                item.section,
                                item.schedule_date,
                                item.created_at,
