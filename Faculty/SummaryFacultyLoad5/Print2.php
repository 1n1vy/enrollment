...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="form-container">
            <form>
                ...
                <div class="flex justify-between items-center">
                    <!-- Print Button -->
                    <a href="#" class="bg-red-600 text-white py-2 px-6 text-sm rounded-full flex items-center shadow-lg print-icon">
                    ...
                    <a href="#" type="submit" style="background-color: #174069;"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        Search
                    </a>
                </div>
        ...
        <div class="fixed bottom-6 right-6">
            <a href="Print1.php" type="submit" style="background-color: #aaa;" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                Back
            </a>
        </div>
</body>
