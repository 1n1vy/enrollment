...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <section class="section-header text-sm md:text-xl">
            <h5 class="text-light">REPORTS - CLASS MASTERLIST</h5>
        </section>
        ...
        <div class="form-container">
            <form action="class_list.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select id="progSection" name="progSection" class="form-select" required>
                ...
                <div class="mb-4 flex items-center space-x-2">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center">
                            <input type="text" id="yearstart" name="yearstart" placeholder="Enter" class="w-full p-2 border border-gray-300 rounded" required>
                            <span class="mx-2 font-bold">TO</span>
                            <input type="text" id="yearend" name="yearend" placeholder="Enter" class="w-full p-2 border border-gray-300 rounded" required>
                        </div>
                    </div>
                </div>
